export default {
  ...
  name: {
    content_scene_sketch: "情景剧日常",
    content_short_drama: "短剧强冲突",
    content_fiction_adaptation: "小说改编",
    content_narration_story: "口播故事",
    content_ad_story: "广告剧情",
    content_education_sketch: "知识小剧场",
    content_travel_video: "旅游视频",
  ...
  tagline: {
    content_scene_sketch: "多人对话 · 生活质感",
    content_short_drama: "竖屏爆点 · 情绪反转",
    content_fiction_adaptation: "人物关系 · 网文镜头",
    content_narration_story: "旁白驱动 · 氛围画面",
    content_ad_story: "产品入戏 · 商业质感",
    content_education_sketch: "讲解清晰 · 小剧场",
    content_travel_video: "街景路线 · 导游讲解",
  ...
  no_video_models_hint: "暂无可用视频模型，请先在「设置 → 供应商」配置 API Key",
  no_image_models_hint: "暂无可用图片模型，请先在「设置 → 供应商」配置 API Key",
  no_text_models_hint: "暂无可用文本模型，请先在「设置 → 供应商」配置 API Key",
  duration_label: "默认时长",
  duration_auto: "auto",
