export default {
  ...
  "clear_search": "清除筛选",
  "travel_reference_search_title": "来自旅游路线参考图",
  "travel_reference_search_desc": "正在按「{{query}}」查找可复用场景素材。原参考图：{{path}}",
  "apply_to_project": "应用回项目",
  "applying_to_project": "应用中...",
  "travel_reference_apply_success": "已把「{{name}}」应用到「{{project}}」场景库",
  "travel_reference_apply_skipped": "「{{name}}」已在「{{project}}」里，未重复应用",
  "travel_reference_apply_failed": "应用到项目失败：{{reason}}",
  "unknown_error": "未知错误",
