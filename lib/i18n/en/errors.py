MESSAGES = {
    ...
    "connection_auth_failed": "The request reached the provider, but the API key was rejected. Make sure the key belongs to this provider, was copied fully, has not expired, and that Base URL is correct when using a gateway.",
    "connection_endpoint_not_found": "Connection failed: endpoint not found. Please check that Base URL points to this provider's OpenAI-compatible endpoint.",
    "connection_rate_limited": "Connection failed: the provider is rate-limiting the request or account quota is unavailable. Try again later or check the account balance.",
    "connection_provider_unavailable": "Connection failed: the provider service is temporarily unavailable. Please try again later.",
    ...
    "model_rule_github_url_invalid": "Enter a valid GitHub Skill file, directory, or repository URL",
    "model_rule_github_not_found": "Could not find SKILL.md. Make sure the GitHub URL points to a Skill file, Skill directory, or repository containing SKILL.md.",
    "model_rule_github_fetch_failed": "Failed to import GitHub Skill: {message}",
    "model_rule_github_too_large": "Skill file is larger than 512KB. Split or trim it before importing.",
    "model_rule_github_empty": "Skill file is empty. Check the GitHub URL.",
    # Assistant
    ...
    "unknown_content_type": "Unknown content type: {content_type}",
    "unknown_content_mode": "Unknown content mode: {content_mode}",
    "unknown_generation_mode": "Unknown generation mode: {generation_mode}",
