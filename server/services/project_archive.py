...
from server.services.project_archive_html import render_travel_route_assets_html
from server.services.project_archive_types import (
    ArchiveDiagnostic,
    ArchiveDiagnostics,
    ArchiveMember,
...
# Re-exported so existing ``from server.services.project_archive import ...`` keeps working.
__all__ = [
    "ARCHIVE_FORMAT_VERSION",
    "ARCHIVE_MANIFEST_NAME",
    "ARCHIVE_SCRIPT_SCHEMA_VERSION",
    "ArchiveDiagnostic",
    "ArchiveDiagnostics",
    "ArchiveMember",
...
class ProjectArchiveService:
    ...
    def _render_travel_route_assets_html(cls, manifest: dict[str, Any]) -> str:
        """Delegate to :func:`render_travel_route_assets_html`."""
        return render_travel_route_assets_html(manifest)
